...
grayplot((finalres_orig$bygene - finalres$bygene)*100,
         xlab="gene index", ylab="Difference in % probability (original - reproduction)")
```
...
I'll also save those results in a postscript file for the paper.
